...
export class GeminiProvider extends AIProvider {
    constructor(apiKey, model) {
        ...
        // Use gemini-3.7-flash as default, migrate deprecated older flash models
        let targetModel = model || 'gemini-3.7-flash';
        if (targetModel === 'gemini-1.5-flash' || targetModel === 'gemini-2.5-flash' || targetModel === 'gemini-3.5-flash' || targetModel === 'gemini-3.6-flash') {
